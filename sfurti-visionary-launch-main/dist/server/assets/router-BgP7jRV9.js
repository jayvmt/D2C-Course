...
const appCss = "/assets/styles-B4V54Taj.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "A luxury one-page experience for a premium business mentor, showcasing expertise and insights." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "A luxury one-page experience for a premium business mentor, showcasing expertise and insights." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "A luxury one-page experience for a premium business mentor, showcasing expertise and insights." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02e516a2-2607-4a84-b1a4-e8fc6dd20a47/id-preview-2c2e12bb--f45e24dd-2501-4c95-b2e8-1c3fda08dbde.lovable.app-1778505424949.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02e516a2-2607-4a84-b1a4-e8fc6dd20a47/id-preview-2c2e12bb--f45e24dd-2501-4c95-b2e8-1c3fda08dbde.lovable.app-1778505424949.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-L1geRbgQ.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A founder's curriculum on positioning, pricing, packaging, and the psychology that decides whether a brand survives."
    }, {
      property: "og:title",
      content: "D2C by VMT — Mentor to Founders"
    }, {
      property: "og:description",
      content: "Learn the part of business nobody teaches. Curriculum, mentorship, and the strategy behind brands that last."
    }]
  })
});
